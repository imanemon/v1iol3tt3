  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Pesanan Baru Violette
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active">Pesanan Baru Violette</li>
      </ol>
    </section>
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Form Pesanan Baru Violette</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" action="<?php echo base_url('admin/simpan_pesanan_baru')?>" method="POST">
              <div class="box-body">
