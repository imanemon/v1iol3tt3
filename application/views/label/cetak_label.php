        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
			...
			<table class="table table-bordered table-striped table-condensed" id="input_fields_wrap">
                ...
                <a href="<?php echo base_url('admin/print_label')?>" target="_blank" class="tambah_baru btn btn-primary" style="float:right;padding-button:0px;margin-right:10px"><i class="fa fa-print"></i> Cetak Menjadi Label</a>
              </div>
          </div>
          <!-- /.box -->
		</div>
